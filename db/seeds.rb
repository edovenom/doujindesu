...
user_details1 = {email: "darkwoodpresents@gmail.com", name:"WoodyDark", password:"2345"}
user_details2 = {email: "jeffreys466453@gmail.com", name:"Jeffrey", password:"2345", permission_level: 1}
User.create(user_details1)
User.create(user_details2)
...
Album.create({title: "Vibrant Dancefloor", album_code: "FS0004", artist: "Frozen Starfall", preview_link: links.sample, user_id: 1, cover_link: picture.sample})
...
Album.create({title: "PROMISED DANCEFLOOR", artist: "Frozen Starfall", album_code: "FS0001", preview_link: links.sample, user_id: 1, cover_link: picture.sample})
Album.create({title: "OCEAN OF BLOSSOMS", artist: "Frozen Starfall", album_code: "FS0002", preview_link: links.sample, user_id: 1, cover_link: picture.sample})
Album.create({title: "EXPEDITION", artist: "Frozen Starfall", album_code: "	FS0003", preview_link: links.sample, user_id: 1, cover_link: picture.sample})
